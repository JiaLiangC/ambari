...
CREATE TABLE mpack_target_resource(
  ...
  target_incarnation VARCHAR2(36) NOT NULL,
  host_name VARCHAR2(255) NOT NULL,
  component_name VARCHAR2(255) NOT NULL,
  mpack_id NUMBER(19),
  materialized_mpack_id NUMBER(19),
  task_id NUMBER(19) NOT NULL,
  resource_state VARCHAR2(32) NOT NULL,
  task_binding CLOB NOT NULL,
  resource_evidence CLOB,
...
INSERT INTO roleauthorization(authorization_id, authorization_name)
  ...
  SELECT 'SERVICE.PURGE_DATA', 'Purge retained service data' FROM dual UNION ALL
