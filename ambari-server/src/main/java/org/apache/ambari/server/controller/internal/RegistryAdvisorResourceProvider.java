...
public abstract class RegistryAdvisorResourceProvider extends AbstractControllerResourceProvider {
   ...
   */
  protected RegistryAdvisorResourceProvider(Resource.Type type, Set<String> propertyIds,
  ...
  protected RegistryAdvisorRequest createRegistryAdvisorRequest(Request request) {
    try {
      Long registryId = Long.valueOf(String.valueOf(
          getRequestProperty(request, REGISTRY_ID_PROPERTY_ID)));
