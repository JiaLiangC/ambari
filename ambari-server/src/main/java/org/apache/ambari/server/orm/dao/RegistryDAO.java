...
public class RegistryDAO {
  ...
  @Transactional
  public RegistryEntity merge(RegistryEntity registryEntity) {
    return m_entityManagerProvider.get().merge(registryEntity);
  }

  @Transactional
  public void removeById(Long registryId) {
    RegistryEntity entity = findById(registryId);
    if (entity != null) {
      m_entityManagerProvider.get().remove(entity);
    }
  }
}
